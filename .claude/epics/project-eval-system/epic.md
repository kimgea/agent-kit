...
- [ ] 001.md - Define protocols, state, and portable bundles (parallel: false)
- [ ] 002.md - Build isolated case preparation and grading (parallel: false)
- [ ] 003.md - Add the fixed Codex runner and measurement (parallel: false)
